  ...
  return (
    <div>
      <div className="grid grid-cols-[200px_540px_300px]  justify-center  bg-primaryBlack py-4 lg:gap-x-20">
        ...
        {/* Buttons */}
        <div className="flex self-end ">
          <button className=" mr-4 w-1/2 rounded-2xl border bg-primaryGreen  p-1 text-sm  font-bold   text-primaryBlack transition-transform hover:scale-105 hover:border-transparent">
            Hizmet Ver
          </button>
      ...
      {/* Sub NavIcon */}
      <div className=" grid grid-cols-[900px] justify-center  bg-primaryGreen py-4">
      ...
      {/* Sub Navbar */}
      <div className="grid grid-cols-[850px] justify-center   py-4">
